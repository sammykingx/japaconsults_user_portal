...
export const AllStaffsOverviewBox: React.FC<AllAdminsOverviewBoxProp> = ({ active }) => {

    return (
        <>
            <div className={`w-[250px] rounded-xl bg-[#8D7986]/30 p-4 border ${active && "border border-brandColor"}`}>
